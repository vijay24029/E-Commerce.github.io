...
<body>
  ...
  <nav class="navbar navbar-expand-lg   navbar-light side2 sticky-top"  >
    <div class="container-fluid">
      <a class="navbar-brand ms-lg-5 ms-md-5 ms-4" href="#"><img src="img/logo.png" alt="" width="50" ></a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto side1">
          <li class="nav-item ms-4 fs-5 mt-lg-0 mt-md-4 mt-3">
          ...
          <li class="nav-item ms-4 fs-5">
            <a class="nav-link active fw-bold " aria-current="page" href="women.html"><i
                class="fa-solid fa-person-dress me-2"></i> Women</a>
          </li>
          <li class="nav-item ms-4 fs-5">
      ...
      <div class="d-none d-lg-block side">
        <i class="fa-solid fa-search ms-5 fs-5 p-2"></i> <i class="fa-solid fa-cart-arrow-down me-2 fs-5 p-2" onclick="log1()"></i><i class="fa-solid fa-user fs-5 me-5 ms-2" onclick="log()"></i>
      </div>
